...
from util import LoadData, Load, Save, DisplayPlot, DisplayPlot2
import sys
import numpy as np
...
def Train(model, forward, backward, update, eps, momentum, num_epochs,
    ...
    # DisplayPlot2(train_ce_list, valid_ce_list, 'Cross Entropy', number=0)
    # DisplayPlot2(train_acc_list, valid_acc_list, 'Accuracy', number=1)
    # print()
